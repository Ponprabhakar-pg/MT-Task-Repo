...
function scrap(){
    ...
    xhr.send("username="+localStorage.eausername);
}
...
function scrap1(){
    ...
    xhr.send("name="+orgname+"&age="+age+"&username="+localStorage.eausername+"&password="+password+"&phone="+phn+"&mailid="+mail+"&address="+addr+"&dob="+dob+"&foi="+foi+"&designation="+des);
}
